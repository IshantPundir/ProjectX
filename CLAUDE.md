...
| 3D | Audio pipeline cutover (LK Cloud + ai-coustics QUAIL_L + adaptive interruption + ai-coustics built-in VAD) shipped 2026-05-06 (spec: `docs/superpowers/specs/2026-05-06-audio-pipeline-design.md`). Real-time `analysis` (scoring, probe selection) + `reporting` (post-session report) still pending | 🟡 partial |
