...
async def update_unit(
    ...
    try:
        unit = await update_org_unit(
            ...
            actor_email=ctx.user.email,
            ip_address=request.client.host if request.client else None,
            about=data.about,           set_about=data.set_about,
            industry=data.industry,     set_industry=data.set_industry,
            hiring_bar=data.hiring_bar, set_hiring_bar=data.set_hiring_bar,
            website=data.website,       set_website=data.set_website,
            country=data.country,       set_country=data.set_country,
            state=data.state,           set_state=data.set_state,
            city=data.city,             set_city=data.set_city,
            metadata=data.metadata,
