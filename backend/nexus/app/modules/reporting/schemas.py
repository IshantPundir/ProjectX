...
class SignalAssessmentOut(BaseModel):
    signal: str
    # Crisp 1-4 word glance title for `signal` (the verbose competency statement),
    # generated by the report scorer. None on older reports / label-gen failure —
    # consumers fall back to `signal`.
