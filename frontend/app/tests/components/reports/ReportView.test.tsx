...
// ReportView embeds <SessionPlayback> and <ProctoringIntegrityPanel>, which
// call query hooks. Mock both so this stays a focused layout test
// (no QueryClient / network required).
